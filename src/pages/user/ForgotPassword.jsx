...
const ForgotPassword = () => {
  ...
  return (
    ...
    >
      {/* Khung quên mật khẩu – đẹp giống hệt Đăng nhập & Đăng ký */}
      <div
      ...
      >
        ...
        <p className="text-center mb-5" style={{ color: "#555", fontSize: "17px", lineHeight: "1.6" }}>
          Đừng lo! Chỉ cần nhập email của bạn, chúng tôi sẽ gửi link đặt lại mật khẩu ngay lập tức.
        </p>
        ...
        {message && (
          <div
            ...
            style={{
              background: message.includes("gửi") || message.includes("thành công") 
                ? "#d5f5e3" 
                : "#fadbd8",
              color: message.includes("gửi") || message.includes("thành công") 
                ? "#27ae60" 
                : "#e74c3c",
              border: "none",
              fontWeight: 600,
