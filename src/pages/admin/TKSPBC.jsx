...
import {
    fetchBestSellingYear,
    fetchBestSellingMonthsByYear,
    fetchBestSellingDaysByMonth,
    fetchTotalRevenue,
    fetchBestSellingChart,
  } from "../../api/doanhthu";
import {
  Chart,
  CategoryScale,
...
const ThongKeSPBC = () => {
  ...
  useEffect(() => {
    fetchBestSellingYear().then((response) => {
  ...
  useEffect(() => {
    if (selectedYear) {
      fetchBestSellingMonthsByYear(selectedYear).then((res) => setMonths(res.data));
      fetchData();
    }
  }, [selectedYear]);
  ...
  useEffect(() => {
    if (selectedYear && selectedMonth) {
      fetchBestSellingDaysByMonth(selectedYear, selectedMonth).then((res) => setDays(res.data));
      fetchData();
    }
  }, [selectedMonth]);
  ...
  const fetchData = () => {
    ...
    fetchBestSellingChart(selectedYear, selectedMonth, selectedDay).then((res) => {
      const data = res.data;
