...
// // // // Các trang phụ
// // // const SanPham = () => <h2>Sản Phẩm</h2>;
// // // const Favorites = () => <h2>Yêu Thích</h2>;
// // // const DonHang = () => <h2>Lịch Sử Mua Hàng</h2>;
// // // const GioHang = () => <h2>Giỏ Hàng</h2>;
...
// // //       return () => {
// // //         window.removeEventListener("userNameUpdated", handleUserChange);
// // //       };
// // //     // Cập nhật lại navbar khi trạng thái userName hoặc isAdmin thay đổi
// // //   }, [userName, isAdmin]);

// // //   return (
// // //     <Router>
// // //       {isAdmin ? <AdminNavbar userName={userName} /> : <UserNavbar userName={userName} />}

// // //       <div className="container mt-4">
// // //         <Routes>
// // //           {/* Admin Routes - Bảo vệ bằng điều kiện */}
// // //           {isAdmin && (
// // //             <>
...
// // //               <Route path="/admin/sanpham/form" element={<SanPhamForm />} />
// // //             </>
// // //           )}

// // //           {/* User Routes */}
// // //           {/* <Route path="/trangChu/form" element={<TrangChu />} /> */}
// // //           <Route path="/sanPham" element={<SanPham />} />
// // //           <Route path="/favorites" element={<Favorites />} />
// // //           <Route path="/donHangND/form" element={<DonHang />} />
// // //           <Route path="/giohang" element={<GioHang />} />
// // //           <Route path="/gioiThieu/form" element={<GioiThieu />} />
...
// // //           <Route path="/DoiMatKhau" element={<ChangePassword />} />
// // //           <Route path="/thongtin" element={<UserProfile />} />
// // //           <Route path="/ThayDoiThongTin" element={<EditProfile />} />
...
// //             <Route
// //               path="/admin/sanpham"
// //               element={<AdminLayout userName={userName}><SanPhamList /></AdminLayout>}
// //             />
// //             <Route
// //               path="/admin/sanpham/form"
// //               element={<AdminLayout userName={userName}><SanPhamForm /></AdminLayout>}
// //             />
// //             <Route
// //               path="/categories"
// //               element={<AdminLayout userName={userName}><CategoryList /></AdminLayout>}
// //             />
// //             <Route
// //               path="/categories/add"
// //               element={<AdminLayout userName={userName}><CategoryForm /></AdminLayout>}
// //             />
// //             <Route
...
// //             <Route
// //               path="/User"
// //               element={<AdminLayout userName={userName}><UserList /></AdminLayout>}
// //             />

// //             <Route
// //               path="/Orders"
// //               element={<AdminLayout userName={userName}><OrderListPage /></AdminLayout>}
// //             />


// //             <Route path="/orders/:id" element={<OrderDetailPage />} />

// //         <Route path="/admin/revenue/thongke" element={<ThongKeDoanhThu />} />
// //         <Route path="/admin/revenue/sanphamyeuthich" element={<ThongKeSPYT />} />
// //         <Route path="/admin/revenue/sanphambanchay" element={<ThongKeSPBC />} />
...
// //             <Route
// //               path="/sanPham"
// //               element={<UserLayout userName={userName}><SanPham /></UserLayout>}
// //             />
// //             <Route
// //               path="/favorites"
// //               element={<UserLayout userName={userName}><Favorites /></UserLayout>}
// //             />
// //             <Route
// //               path="/donHangND"
// //               element={<UserLayout userName={userName}><OrderList /></UserLayout>}
// //             />
// //             <Route
// //               path="/giohang"
// //               element={<UserLayout userName={userName}><GioHang /></UserLayout>}
// //             />
// //             <Route
// //               path="/gioiThieu/form"
// //               element={<UserLayout userName={userName}><GioiThieu /></UserLayout>}
// //             />
// //             <Route
// //               path="/thongtin"
// //               element={<UserLayout userName={userName}><UserProfile /></UserLayout>}
// //             />
// //             <Route
// //               path="/ThayDoiThongTin"
// //               element={<UserLayout userName={userName}><EditProfile /></UserLayout>}
// //             />
...
// //             <Route
// //               path="/DoiMatKhau"
// //               element={<UserLayout userName={userName}><ChangePassword /></UserLayout>}
// //             />
// //             <Route path="/donHangND/detail/:id" element={<OrderDetail />} />
// //             <Route
// //               path="*"
// //               element={<UserLayout userName={userName}><TrangChu /></UserLayout>}
// //             />
// //           </>
// //         )}
...
//         {userName && !isAdmin && (
//           <>
//             <Route path="/" element={<UserLayout userName={userName}><TrangChu /></UserLayout>} />
//             <Route path="/sanPham" element={<UserLayout userName={userName}><ProductList /></UserLayout>} />
//             <Route path="/favorites" element={<UserLayout userName={userName}><Favorites /></UserLayout>} />
//             <Route path="/donHangND" element={<UserLayout userName={userName}><OrderList /></UserLayout>} />
//             <Route path="/donHangND/detail/:id" element={<UserLayout userName={userName}><OrderDetail /></UserLayout>} />
//             <Route path="/product/:id" element={<UserLayout userName={userName}><ProductDetailForm /></UserLayout>} />

//             <Route path="/giohang" element={<UserLayout userName={userName}><Giohang /></UserLayout>} />
//             <Route path="/gioiThieu/form" element={<UserLayout userName={userName}><GioiThieu /></UserLayout>} />
//             <Route path="/thongtin" element={<UserLayout userName={userName}><UserProfile /></UserLayout>} />
//             <Route path="/ThayDoiThongTin" element={<UserLayout userName={userName}><EditProfile /></UserLayout>} />
//             <Route path="/DoiMatKhau" element={<UserLayout userName={userName}><ChangePassword /></UserLayout>} />
//           </>
//         )}
...
//               ) : (
//                 <UserLayout userName={userName}><TrangChu /></UserLayout>
//               )
//             ) : (
//               <LoginPage />
//             )
      ...
      <Routes>
        ...
        {userName && !isAdmin && (
          <>
            ...
            <Route path="/quenmatkhau" element={<UserLayout><ForgotPassword /></UserLayout>} />
